...
import { ChartKitCurrentChart } from '~/components/charts/ChartKitCurrentChart';
      ...
      <Card>
            ...
            <View className="flex-row items-center justify-between">
              ...
              <View className="flex-row items-center gap-4">
                <View className="rounded-full bg-indigo-500/20 p-2">
                  <MoveHorizontal size={24} color={COLORS.chart.current} />
                </View>
        ...
        <CollapsibleContent>
          <CardContent className="px-4 pb-4">
            ...
            <ChartKitCurrentChart data={currentChartData} />
